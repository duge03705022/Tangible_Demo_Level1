...
public class RFIBricks_Cores
{
	...
	{
		BoardBlockMappingArray[index] = Value;
	}

	string BoardType = "9999 ";

	public int DisappearTime_20170604 = RestartTime;//600;
	...
	public void ComputingTheStackedOrders3D_20170603(string stackedOrder)
	{
		...
		int X1 = -1, Y1 = -1, Z1 = -1, X2 = -1, Y2 = -1, Z2 = -1, BlockID1 = 0, BlockID2 = 0, BlockSN2 = 0, BlockSurfaceID1 = 0, BlockSurfaceID2 = 0, StackWay1 = 0, StackWay2 = 0, BlockIDType1 = 0, BlockIDType2 = 0/*, BlockDirectionID1 = 0, BlockDirectionID2 = 0*/;
	...
	public void Operating3DPosition(string stringX)
	{
		...
		int X1 = -1, Y1 = -1, Z1 = -1, X2 = -1, Y2 = -1, Z2 = -1, BlockID1 = 0, BlockID2 = 0, BlockSurfaceID1 = 0, BlockSurfaceID2 = 0, StackWay1 = 0, StackWay2 = 0, BlockIDType1 = 0, BlockIDType2 = 0/*, BlockDirectionID1 = 0, BlockDirectionID2 = 0*/;
	...
	private void Update_DispearIDs_20170604()
	{
			...
			for (int j = 0; j < tmps.Length; j++)
			{
				try
				{
					if (DetectedIDs.Contains(tmps[j]) == false && DispearIDs_DispearedTime.ContainsKey(tmps[j]) == false)
					{
						...
						//Debug.Log("DispearIDs_DispearedTime.put() :" + tmps[j] +",");
					}
				}
				catch (Exception) { }
			}
		...
		foreach (String id in DispearIDs_DispearedTime.Keys)
		{
			...
			if ((CurrentTimeMillis() - (long)DispearIDs_DispearedTime[id]) >= DisappearTime_20170604 * 1)
			if (StackedIDs.Contains(id) == false)
			{
				DispearIDs_DispearedTime.Remove(id);
